...
Shader "Meenphie/Lightmapping/Simple/Opaque (Outline)"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _EMISSION_ON
				float3 staticSwitch851_g1496 = ( _EmissionColor + tex2D( _EmissionMap, uv_EmissionMap81_g1496 ).rgb );
			#else
			...
			float3 lerpResult46_g1511 = lerp( tex2D( _Lightmap, UV32_g1511 ).rgb , tex2D( _Lightmap, UV22_g1511 ).rgb , W02_g1511);
			float3 lerpResult45_g1511 = lerp( tex2D( _Lightmap, UV12_g1511 ).rgb , tex2D( _Lightmap, UV02_g1511 ).rgb , W02_g1511);
			float3 lerpResult44_g1511 = lerp( lerpResult46_g1511 , lerpResult45_g1511 , W12_g1511);
			float3 Output_2D131_g1511 = lerpResult44_g1511;
			float Lightmap_GUI886_g1496 = ( _CATEGORYLIGHTMAPPING + _CATEGORYSPACELIGHTMAPPING );
			float3 temp_cast_1 = (Lightmap_GUI886_g1496).xxx;
			float3 lerpResult882_g1496 = lerp( Output_2D131_g1511 , temp_cast_1 , float3( 0,0,0 ));
			float3 Lightmap46_g1496 = lerpResult882_g1496;
			float3 temp_output_614_0_g1496 = ( Albedo6_g1496 * Lightmap46_g1496 );
			o.Emission = ( Emission86_g1496 + temp_output_614_0_g1496 );
			float2 uv_MetallicMap = i.uv_texcoord * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
			float saferPower803_g1496 = abs( tex2D( _MetallicMap, uv_MetallicMap ).a );
			#ifdef _METALLICMAP
			...
			float dotResult835_g1496 = dot( Lightmap46_g1496 , float3( 0.299, 0.587, 0.114 ) );
...
/*ASEBEGIN
Version=19903
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2867;192,-1200;Inherit;False;Meenphie;0;;1496;b3ba55a08dd6b49c7be16c6f35cf2033;5,869,1,871,1,872,1,847,0,867,1;0;9;FLOAT3;625;FLOAT3;238;FLOAT3;624;FLOAT;96;FLOAT;97;FLOAT;95;FLOAT;156;FLOAT;427;FLOAT3;860
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1092;512,-1200;Float;False;True;-1;3;AmplifyShaderEditor.MaterialInspector;0;0;Standard;Meenphie/Lightmapping/Simple/Opaque (Outline);False;False;False;False;False;False;False;True;True;False;False;False;False;False;False;True;False;False;True;True;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;False;0;False;Opaque;;Geometry;ForwardOnly;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0.0001;0,0,0,0;VertexOffset;False;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=7B4E38123288E548E8AD928EFEBA53574CE4F04A