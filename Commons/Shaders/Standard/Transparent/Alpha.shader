		...
		Pass
		{
			...
			CGPROGRAM
				...
				) : SV_Target
				{
					...
					#if defined( _UV_UV0 )
					float2 staticSwitch2671_g60072 = MainUV2420_g60072;
					#elif defined( _UV_UV2 )
					...
					#if defined( _UV_UV0 )
					float2 staticSwitch2644_g60072 = MainUV2420_g60072;
					#elif defined( _UV_UV2 )
					...
					#if defined( _UV_UV0 )
					float2 staticSwitch3312_g60072 = MainUV2420_g60072;
					#elif defined( _UV_UV2 )
					...
					float2 MainUV97_g60077 = MainUV2420_g60072;
					float4 texCoord2426_g60072 = IN.ase_texcoord;
					texCoord2426_g60072.xy = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 LightmapUV2361_g60072 = (texCoord2426_g60072).zw;
					float2 LightmapUV97_g60077 = LightmapUV2361_g60072;
					...
					LayeredLightmapLighting( Color97_g60077 , Metallic97_g60077 , Roughness97_g60077 , ViewDir97_g60077 , WorldPos97_g60077 , Normal97_g60077 , WorldNormal97_g60077 , MainUV97_g60077 , LightmapUV97_g60077 , LightGroupMask97_g60077 , IsDynamicMesh97_g60077 , DiffuseMaskedLights97_g60077 , Diffuse97_g60077 , Specular97_g60077 , Reflection97_g60077 );
					...
					float2 staticSwitch2642_g60072 = MainUV2420_g60072;
...
ASEEND*/
//CHKSM=A73DB5B1DFD3E2F4E5A776D79DAA2D55A49BDEF4