		...
		Pass
		{
			...
			CGPROGRAM
				...
				) : SV_Target
				{
					...
					float localLayeredLightmapLighting97_g60089 = ( 0.0 );
					float2 texCoord2357_g60084 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 MainUV2420_g60084 = texCoord2357_g60084;
					float2 texCoord2594_g60084 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
					float2 UV_Decal2595_g60084 = texCoord2594_g60084;
					#if defined( _UV_UV0 )
					float2 staticSwitch3313_g60084 = MainUV2420_g60084;
					#elif defined( _UV_UV2 )
					float2 staticSwitch3313_g60084 = UV_Decal2595_g60084;
					#else
					float2 staticSwitch3313_g60084 = UV_Decal2595_g60084;
					#endif
					float4 temp_output_3155_0_g60084 = ( _Color * tex2D( _MainTex, staticSwitch3313_g60084 ) );
					float3 oAlbedo6_g60084 = (temp_output_3155_0_g60084).rgb;
					float3 Color97_g60089 = oAlbedo6_g60084;
					#if defined( _UV_UV0 )
					float2 staticSwitch2671_g60084 = MainUV2420_g60084;
					#elif defined( _UV_UV2 )
					float2 staticSwitch2671_g60084 = UV_Decal2595_g60084;
					#else
					float2 staticSwitch2671_g60084 = UV_Decal2595_g60084;
					#endif
					#ifdef _METALLICMAP
					float staticSwitch846_g60084 = tex2D( _MetallicMap, staticSwitch2671_g60084 ).r;
					#else
					float staticSwitch846_g60084 = _Metallic;
					#endif
					float Metallic1239_g60084 = staticSwitch846_g60084;
					float Metallic97_g60089 = Metallic1239_g60084;
					#if defined( _UV_UV0 )
					float2 staticSwitch2644_g60084 = MainUV2420_g60084;
					#elif defined( _UV_UV2 )
					float2 staticSwitch2644_g60084 = UV_Decal2595_g60084;
					#else
					float2 staticSwitch2644_g60084 = UV_Decal2595_g60084;
					#endif
					#ifdef _GLOSSINESSMAP
					float staticSwitch845_g60084 = tex2D( _GlossinessMap, staticSwitch2644_g60084 ).r;
					#else
					float staticSwitch845_g60084 = _Glossiness;
					#endif
					float temp_output_19_0_g60088 = staticSwitch845_g60084;
					float Roughness21_g60088 = temp_output_19_0_g60088;
					float Metallic21_g60088 = Metallic1239_g60084;
					#if defined( _UV_UV0 )
					float2 staticSwitch3312_g60084 = MainUV2420_g60084;
					#elif defined( _UV_UV2 )
					float2 staticSwitch3312_g60084 = UV_Decal2595_g60084;
					#else
					float2 staticSwitch3312_g60084 = UV_Decal2595_g60084;
					#endif
					#ifdef _BUMPMAP
					float3 staticSwitch980_g60084 = UnpackScaleNormal( tex2D( _BumpMap, staticSwitch3312_g60084 ), 1.5 );
					#else
					float3 staticSwitch980_g60084 = float3( 0, 0, 1 );
					#endif
					float3 normalizeResult2878_g60084 = normalize( staticSwitch980_g60084 );
					float3 Normal700_g60084 = normalizeResult2878_g60084;
					...
					float3 tanNormal2504_g60084 = Normal700_g60084;
					float3 worldNormal2504_g60084 = normalize( float3( dot( tanToWorld0, tanNormal2504_g60084 ), dot( tanToWorld1, tanNormal2504_g60084 ), dot( tanToWorld2, tanNormal2504_g60084 ) ) );
					float3 World_Normal2508_g60084 = worldNormal2504_g60084;
					float3 WorldNormal21_g60088 = World_Normal2508_g60084;
					float localGeometricAA21_g60088 = GeometricAA( Roughness21_g60088 , Metallic21_g60088 , WorldNormal21_g60088 );
					#ifdef _USEGEOMETRICAA_ON
					float staticSwitch15_g60088 = localGeometricAA21_g60088;
					#else
					float staticSwitch15_g60088 = temp_output_19_0_g60088;
					#endif
					float Roughness1399_g60084 = staticSwitch15_g60088;
					float Roughness97_g60089 = Roughness1399_g60084;
					...
					float3 View_Direction2511_g60084 = ase_viewDirWS;
					float3 ViewDir97_g60089 = View_Direction2511_g60084;
					float3 World_Position2505_g60084 = ase_positionWS;
					float3 WorldPos97_g60089 = World_Position2505_g60084;
					float3 Normal97_g60089 = Normal700_g60084;
					...
					float2 LightmapUV2361_g60084 = (texCoord2426_g60084).zw;
					...
					float ProbeIndex97_g60089 = 0.0;
					float3 DiffuseMaskedLights97_g60089 = float3( 0,0,0 );
					float3 Diffuse97_g60089 = float3( 0,0,0 );
					float3 Specular97_g60089 = float3( 0,0,0 );
					float3 Reflection97_g60089 = float3( 0,0,0 );
					LayeredLightmapLighting( Color97_g60089 , Metallic97_g60089 , Roughness97_g60089 , ViewDir97_g60089 , WorldPos97_g60089 , Normal97_g60089 , WorldNormal97_g60089 , MainUV97_g60089 , LightmapUV97_g60089 , LightGroupMask97_g60089 , IsDynamicMesh97_g60089 , ProbeIndex97_g60089 , DiffuseMaskedLights97_g60089 , Diffuse97_g60089 , Specular97_g60089 , Reflection97_g60089 );
					#ifdef _DIFFUSEMASKEDLIGHTS_ON
					float3 staticSwitch3306_g60084 = DiffuseMaskedLights97_g60089;
					#else
					float3 staticSwitch3306_g60084 = Diffuse97_g60089;
					#endif
					#ifdef _DIFFUSE_ON
					float3 staticSwitch3319_g60084 = staticSwitch3306_g60084;
					#else
					float3 staticSwitch3319_g60084 = _Vector0;
					#endif
					float3 Diffuse2560_g60084 = staticSwitch3319_g60084;
					#ifdef _SPECULARS_ON
					float3 staticSwitch3317_g60084 = Specular97_g60089;
					#else
					float3 staticSwitch3317_g60084 = _Vector0;
					#endif
					float3 Speculars3240_g60084 = staticSwitch3317_g60084;
					#ifdef _REFLECTIONS_ON
					float3 staticSwitch3318_g60084 = Reflection97_g60089;
					#else
					float3 staticSwitch3318_g60084 = _Vector0;
					#endif
					float3 Reflections1419_g60084 = staticSwitch3318_g60084;
					#if defined( _EMISSIONUV_UV0 )
					float2 staticSwitch2642_g60084 = MainUV2420_g60084;
					#elif defined( _EMISSIONUV_UV2 )
					float2 staticSwitch2642_g60084 = UV_Decal2595_g60084;
					#else
					float2 staticSwitch2642_g60084 = MainUV2420_g60084;
					#endif
					float3 Emission86_g60084 = ( _EmissionColor * tex2D( _EmissionMap, staticSwitch2642_g60084 ).rgb * _EmissionIntensity );
					#ifdef SHADER_API_MOBILE
					float4 staticSwitch1_g60085 = float4( ( Diffuse2560_g60084 + Reflections1419_g60084 + Emission86_g60084 ) , 0.0 );
					#else
					float4 staticSwitch1_g60085 = float4( ( Diffuse2560_g60084 + Speculars3240_g60084 + Reflections1419_g60084 + Emission86_g60084 ) , 0.0 );
					#endif
					float4 Color357_g60086 = staticSwitch1_g60085;
					...
					float Alpha = temp_output_3155_0_g60084.a;
...
ASEEND*/
//CHKSM=B726BA5793EB66961EC2A33F10CEAB8A34287575