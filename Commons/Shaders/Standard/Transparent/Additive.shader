		...
		Pass
		{
			...
			CGPROGRAM
				...
				) : SV_Target
				{
					...
					float3 Color97_g60066 = oAlbedo6_g60061;
					#if defined( _UV_UV0 )
					float2 staticSwitch2671_g60061 = UV_Diffuse2420_g60061;
					#elif defined( _UV_UV2 )
					...
					float Metallic97_g60066 = Metallic1239_g60061;
					#if defined( _UV_UV0 )
					float2 staticSwitch2644_g60061 = UV_Diffuse2420_g60061;
					#elif defined( _UV_UV2 )
					...
					#endif
					float temp_output_19_0_g60065 = staticSwitch845_g60061;
					float Roughness21_g60065 = temp_output_19_0_g60065;
					float Metallic21_g60065 = Metallic1239_g60061;
					#if defined( _UV_UV0 )
					float2 staticSwitch3312_g60061 = UV_Diffuse2420_g60061;
					#elif defined( _UV_UV2 )
					...
					float3 WorldNormal21_g60065 = World_Normal2508_g60061;
					float localGeometricAA21_g60065 = GeometricAA( Roughness21_g60065 , Metallic21_g60065 , WorldNormal21_g60065 );
					...
					#endif
					float Roughness1399_g60061 = staticSwitch15_g60065;
					float Roughness97_g60066 = Roughness1399_g60061;
					...
					float3 ViewDir97_g60066 = View_Direction2511_g60061;
					float3 World_Position2505_g60061 = ase_positionWS;
					float3 WorldPos97_g60066 = World_Position2505_g60061;
					float3 Normal97_g60066 = Normal700_g60061;
					float3 WorldNormal97_g60066 = World_Normal2508_g60061;
					float4 texCoord2426_g60061 = IN.ase_texcoord;
					texCoord2426_g60061.xy = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
					float2 UV_Lightmap2361_g60061 = (texCoord2426_g60061).zw;
					float2 LightmapUV97_g60066 = UV_Lightmap2361_g60061;
					float LightGroupMask97_g60066 = _LightGroupMask;
					float IsDynamicMesh97_g60066 = _IsDynamicMesh;
					float3 DiffuseMaskedLights97_g60066 = float3( 0,0,0 );
					float3 Diffuse97_g60066 = float3( 0,0,0 );
					float3 Specular97_g60066 = float3( 0,0,0 );
					float3 Reflection97_g60066 = float3( 0,0,0 );
					LayeredLightmapLighting( Color97_g60066 , Metallic97_g60066 , Roughness97_g60066 , ViewDir97_g60066 , WorldPos97_g60066 , Normal97_g60066 , WorldNormal97_g60066 , LightmapUV97_g60066 , LightGroupMask97_g60066 , IsDynamicMesh97_g60066 , DiffuseMaskedLights97_g60066 , Diffuse97_g60066 , Specular97_g60066 , Reflection97_g60066 );
					#ifdef _DIFFUSEMASKEDLIGHTS_ON
					float3 staticSwitch3306_g60061 = DiffuseMaskedLights97_g60066;
					#else
					float3 staticSwitch3306_g60061 = Diffuse97_g60066;
					#endif
					#ifdef _DIFFUSE_ON
...
{"type":"AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor","id":3083,"pos":[512,-1200],"params":["Float","False","True","-1","3","AmplifyShaderEditor.MaterialInspector","0","7","Meenphie/Standard/Transparent/Additive","0770190933193b94aaa3065e307002fa","True","Unlit","0","1","Unlit","8","False","True","1","1","False","","0","False","","1","1","False","","0","False","","True","1","False","","1","False","","False","False","False","False","False","False","False","False","False","True","0","False","","True","True","0","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","False","True","1","False","","False","False","False","True","2","RenderType=Transparent=RenderType","Queue=Transparent=Queue=0","True","3","True","4","d3d11","gles3","metal","vulkan","0","False","True","1","1","False","","1","False","","1","1","False","","10","False","","True","1","False","","1","False","","False","False","False","False","False","False","False","False","False","False","True","True","2","False","","False","True","True","True","True","True","0","False","","False","False","False","False","False","False","False","True","False","0","False","","255","False","","255","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","0","False","","True","True","2","False","","True","3","False","","True","True","0","True","_Offset","0","True","_Offset","False","True","1","LightMode=ForwardBase","False","False","0","","0","0","Standard","10","Surface","1","639175542747890460","  Keep Alpha","0","0","  Blend","2","639175542775987960","Alpha Clipping","0","0","  Use Shadow Threshold","0","0","Cast Shadows","0","639175542789685200","Write Depth","0","0","  Conservative","0","0","Extra Pre Pass","0","0","Vertex Position","1","0","0","3","False","True","False","False","","False","0"]}
...
ASEEND*/
//CHKSM=A46ACB9B2452B5F279C9CA06B37FD10D882066CF