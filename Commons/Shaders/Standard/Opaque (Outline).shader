...
Shader "Meenphie/Standard/Opaque (Outline)"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _MAINTEX
				float4 staticSwitch899_g1528 = tex2D( _MainTex, uv_MainTex907_g1528 );
			#else
				float4 staticSwitch899_g1528 = _Color;
			#endif
			float4 Albedo6_g1528 = staticSwitch899_g1528;
			...
			#ifdef _EMISSION_ON
				float4 staticSwitch851_g1528 = ( _EmissionColor + tex2D( _EmissionMap, uv_EmissionMap81_g1528 ) );
			#else
				float4 staticSwitch851_g1528 = temp_cast_1;
			#endif
			float4 Emission86_g1528 = staticSwitch851_g1528;
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2880;192,-1200;Inherit;False;Meenphie;0;;1528;b3ba55a08dd6b49c7be16c6f35cf2033;10,871,0,872,0,869,0,847,0,867,1,947,0,912,0,944,0,938,0,905,0;0;9;COLOR;625;FLOAT3;238;COLOR;624;FLOAT;96;FLOAT;97;FLOAT;95;FLOAT;156;FLOAT;427;FLOAT3;860
...
ASEEND*/
//CHKSM=DDEFC822259495E5BD9ECA3F3EC404A31C06EF9C