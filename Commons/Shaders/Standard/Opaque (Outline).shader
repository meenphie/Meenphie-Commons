...
Shader "Meenphie/Standard/Opaque (Outline)"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _BUMPMAP
				float3 staticSwitch980_g1528 = UnpackScaleNormal( tex2D( _BumpMap, uv_BumpMap830_g1528 ), _NormalScale );
			#else
				float3 staticSwitch980_g1528 = float3( 0, 0, 1 );
			#endif
			float3 Normal_Map700_g1528 = staticSwitch980_g1528;
			o.Normal = Normal_Map700_g1528;
			float2 uv_MainTex907_g1528 = i.uv_texcoord;
			float4 Albedo6_g1528 = ( _Color * tex2D( _MainTex, uv_MainTex907_g1528 ) );
			o.Albedo = Albedo6_g1528.rgb;
			float Metallic_Value893_g1528 = _Metallic;
			float White38_g1528 = 1.0;
			float Lightmap46_g1528 = White38_g1528;
			float4 temp_output_614_0_g1528 = ( Albedo6_g1528 * ( ( 1.0 - Metallic_Value893_g1528 ) * Lightmap46_g1528 ) );
			float4 temp_cast_1 = 0;
			float2 uv_EmissionMap81_g1528 = i.uv_texcoord;
			float4 lerpResult974_g1528 = lerp( temp_cast_1 , ( _EmissionColor + tex2D( _EmissionMap, uv_EmissionMap81_g1528 ) ) , _EmissionEnabled);
			float4 Emission86_g1528 = lerpResult974_g1528;
			o.Emission = ( temp_output_614_0_g1528 * Emission86_g1528 ).rgb;
			float2 uv_MetallicMap48_g1528 = i.uv_texcoord;
			float saferPower803_g1528 = abs( tex2D( _MetallicMap, uv_MetallicMap48_g1528 ).a );
			#ifdef _METALLICMAP
			...
			float3 temp_output_3_0_g1570 = ddx( ase_normalWS );
			float dotResult5_g1570 = dot( temp_output_3_0_g1570 , temp_output_3_0_g1570 );
			float3 temp_output_4_0_g1570 = ddy( ase_normalWS );
			float dotResult6_g1570 = dot( temp_output_4_0_g1570 , temp_output_4_0_g1570 );
			#ifdef _USEGEOMETRICANTIALIASING_ON
				float staticSwitch824_g1528 = min( staticSwitch845_g1528 , ( 1.0 - pow( saturate( max( dotResult5_g1570 , dotResult6_g1570 ) ) , 0.333 ) ) );
			#else
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2880;192,-1200;Inherit;False;Meenphie;0;;1528;b3ba55a08dd6b49c7be16c6f35cf2033;10,871,0,869,0,872,0,847,0,867,1,944,0,947,0,905,0,938,0,912,0;0;9;COLOR;625;FLOAT3;238;COLOR;624;FLOAT;96;FLOAT;97;FLOAT;95;FLOAT;156;FLOAT;427;FLOAT3;860
Node;AmplifyShaderEditor.StandardSurfaceOutputNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1092;512,-1200;Float;False;True;-1;3;AmplifyShaderEditor.MaterialInspector;0;0;Standard;Meenphie/Standard/Opaque (Outline);False;False;False;False;False;False;False;True;True;False;False;False;False;False;False;True;False;False;True;True;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;False;0;False;Opaque;;Geometry;ForwardOnly;6;d3d11;glcore;gles;gles3;metal;vulkan;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0.0001;0,0,0,0;VertexOffset;False;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=5DFB4A72DA38C683E1AF749096F08CF4D580B3AE