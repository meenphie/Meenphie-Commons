		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float2 texCoord2357_g59838 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
					half2 UV0A2420_g59838 = texCoord2357_g59838;
					float2 texCoord2594_g59838 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
					...
					float3 Color1_g59937 = oAlbedo6_g59838;
					#if defined( _UV_UV0 )
					...
					float Metallic1_g59937 = Metallic1239_g59838;
					#if defined( _UV_UV0 )
					...
					float Smoothness1_g59937 = Smoothness1399_g59838;
					float3 View_Direction2511_g59838 = ViewDirWS;
					float3 ViewDir1_g59937 = View_Direction2511_g59838;
					float3 World_Position2505_g59838 = PositionWS;
					float3 WorldPos1_g59937 = World_Position2505_g59838;
					float3 WorldNormal1_g59937 = World_Normal2508_g59838;
					float4 temp_cast_2 = (Black1185_g59838).xxxx;
					float4 texCoord2426_g59838 = IN.ase_texcoord6;
					texCoord2426_g59838.xy = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
					...
					float dotResult9_g59929 = dot( float3( 0.212673, 0.715152, 0.072175 ) , Lightmap46_g59838 );
					float smoothstepResult2_g59929 = smoothstep( 0.0 , 0.04 , dotResult9_g59929);
					float Lightmap_Mask3067_g59838 = smoothstepResult2_g59929;
					float LightmapMask1_g59937 = Lightmap_Mask3067_g59838;
					...
					float3 staticSwitch2971_g59838 = localIndirectSpecular1_g59937;
					#else
					...
					float3 Color97_g59938 = oAlbedo6_g59838;
					float Metallic97_g59938 = Metallic1239_g59838;
					float Smoothness97_g59938 = Smoothness1399_g59838;
					float3 ViewDir97_g59938 = View_Direction2511_g59838;
					float3 WorldPos97_g59938 = World_Position2505_g59838;
					float3 WorldNormal97_g59938 = World_Normal2508_g59838;
					float White38_g59838 = 1.0;
					#if defined( _LIGHTMAPMODE_DISABLED )
					float staticSwitch3085_g59838 = White38_g59838;
					#elif defined( _LIGHTMAPMODE_SIMPLE )
					float staticSwitch3085_g59838 = Lightmap_Mask3067_g59838;
					#elif defined( _LIGHTMAPMODE_SIMPLELERP )
					float staticSwitch3085_g59838 = Lightmap_Mask3067_g59838;
					#elif defined( _LIGHTMAPMODE_RNM )
					float staticSwitch3085_g59838 = Lightmap_Mask3067_g59838;
					...
					float staticSwitch3085_g59838 = White38_g59838;
					#endif
					float LightmapMask97_g59938 = staticSwitch3085_g59838;
					...
					float3 staticSwitch2969_g59838 = localDirectSpecular97_g59938;
					#else
					...
					#ifdef SHADER_API_MOBILE
					float4 staticSwitch1_g59889 = float4( ( temp_output_1252_0_g59838 + Emission86_g59838 + Indirect_Specular1419_g59838 ) , 0.0 );
					#else
					float4 staticSwitch1_g59889 = float4( ( Emission86_g59838 + Indirect_Specular1419_g59838 + Direct_Specular2560_g59838 + temp_output_1252_0_g59838 ) , 0.0 );
					#endif
					#ifdef _LIGHTMAPDEBUG
					float4 staticSwitch1181_g59838 = float4( Lightmap46_g59838 , 0.0 );
					#else
					float4 staticSwitch1181_g59838 = staticSwitch1_g59889;
					#endif
...
/*ASEBEGIN
Version=19909
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3018;192,-1200;Inherit;False;Meenphie;0;;59838;b3ba55a08dd6b49c7be16c6f35cf2033;6,1008,1,2632,1,2635,1,2619,1,2636,1,2670,1;0;4;FLOAT4;624;FLOAT;156;FLOAT;427;FLOAT3;1024
...
ASEEND*/
//CHKSM=93CDFFB425A0C1407E3A8C14C6ED0C7BB72166DA