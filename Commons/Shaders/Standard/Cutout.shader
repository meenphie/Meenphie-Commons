		...
		Pass
		{
			...
			CGPROGRAM
					...
					) : SV_Target
				{
					...
					#endif
					float3 temp_cast_3 = (White38_g2323).xxx;
					float2 uv2_AmbientOcclusion11631_g2323 = IN.ase_texcoord5.zw;
					#ifdef _USEAMBIENTOCCLUSION_ON
					float3 staticSwitch1638_g2323 = tex2D( _AmbientOcclusion1, uv2_AmbientOcclusion11631_g2323 ).rgb;
					#else
					float3 staticSwitch1638_g2323 = temp_cast_3;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				half4 frag( v2f IN , uint ase_vface : SV_IsFrontFace ) : SV_Target
				{
					...
					#endif
					float3 temp_cast_3 = (White38_g2323).xxx;
					float2 uv2_AmbientOcclusion11631_g2323 = IN.ase_texcoord2.zw;
					#ifdef _USEAMBIENTOCCLUSION_ON
					float3 staticSwitch1638_g2323 = tex2D( _AmbientOcclusion1, uv2_AmbientOcclusion11631_g2323 ).rgb;
					#else
					float3 staticSwitch1638_g2323 = temp_cast_3;
...
/*ASEBEGIN
Version=19905
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2943;160,-1408;Inherit;False;Meenphie Outline;50;;1978;d39aa08508dd494aeb2901b7a0739759;0;0;2;FLOAT3;17;FLOAT3;0
...
ASEEND*/
//CHKSM=2C17457675FE382C35BB50367EC88B1968D2B323