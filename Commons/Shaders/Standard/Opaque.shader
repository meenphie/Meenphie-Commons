	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				float4 MyCustomExpression8_g60740( float4 screenPos, float3 viewDir, float3 worldNormal, float _Steps, float _BinarySteps, float _Thickness )
				{
							...
							) : SV_Target
				{
					...
					float2 texCoord2357_g60687 = IN.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
					half2 UV02420_g60687 = texCoord2357_g60687;
					float2 temp_output_5_0_g60734 = UV02420_g60687;
					float2 UV633_g60734 = temp_output_5_0_g60734;
					float2 UV100_g60735 = UV633_g60734;
					float2 temp_output_51_0_g60735 = mul( float2x2( 1, 0, -0.5773503, 1.154701 ), ( UV100_g60735 * float2( 3.464,3.464 ) ) );
					float2 break55_g60735 = frac( temp_output_51_0_g60735 );
					float temp_output_56_0_g60735 = ( ( 1.0 - break55_g60735.x ) - break55_g60735.y );
					float2 temp_output_52_0_g60735 = floor( temp_output_51_0_g60735 );
					float2 temp_output_125_0_g60735 = ( temp_output_52_0_g60735 + float2( 1,1 ) );
					float2 ifLocalVar87_g60735 = 0;
					if( temp_output_56_0_g60735 > 0.0 )
					ifLocalVar87_g60735 = temp_output_52_0_g60735;
					else if( temp_output_56_0_g60735 == 0.0 )
					ifLocalVar87_g60735 = temp_output_125_0_g60735;
					else if( temp_output_56_0_g60735 < 0.0 )
					ifLocalVar87_g60735 = temp_output_125_0_g60735;
					float3 temp_output_7_0_g60736 = frac( ( (ifLocalVar87_g60735).xyx * float3( 0.1031, 0.103, 0.0973 ) ) );
					float dotResult8_g60736 = dot( temp_output_7_0_g60736 , ( (temp_output_7_0_g60736).yzx + 33.33 ) );
					float3 temp_output_12_0_g60736 = ( temp_output_7_0_g60736 + dotResult8_g60736 );
					float2 temp_output_597_0_g60734 = ( UV100_g60735 + frac( ( ( (temp_output_12_0_g60736).xx + (temp_output_12_0_g60736).yz ) * (temp_output_12_0_g60736).zy ) ) );
					float2 DDX631_g60734 = ddx( temp_output_5_0_g60734 );
					float2 DDY632_g60734 = ddy( temp_output_5_0_g60734 );
					float temp_output_65_0_g60735 = ( 0.0 - temp_output_56_0_g60735 );
					float ifLocalVar59_g60735 = 0;
					if( temp_output_56_0_g60735 <= 0.0 )
					ifLocalVar59_g60735 = temp_output_65_0_g60735;
					else
					ifLocalVar59_g60735 = temp_output_56_0_g60735;
					float temp_output_597_30_g60734 = ifLocalVar59_g60735;
					float2 temp_output_90_0_g60735 = ( temp_output_52_0_g60735 + float2( 0,1 ) );
					float2 temp_output_123_0_g60735 = ( temp_output_52_0_g60735 + float2( 1,0 ) );
					float2 ifLocalVar88_g60735 = 0;
					if( temp_output_56_0_g60735 > 0.0 )
					ifLocalVar88_g60735 = temp_output_90_0_g60735;
					else if( temp_output_56_0_g60735 == 0.0 )
					ifLocalVar88_g60735 = temp_output_123_0_g60735;
					else if( temp_output_56_0_g60735 < 0.0 )
					ifLocalVar88_g60735 = temp_output_123_0_g60735;
					float3 temp_output_7_0_g60737 = frac( ( (ifLocalVar88_g60735).xyx * float3( 0.1031, 0.103, 0.0973 ) ) );
					float dotResult8_g60737 = dot( temp_output_7_0_g60737 , ( (temp_output_7_0_g60737).yzx + 33.33 ) );
					float3 temp_output_12_0_g60737 = ( temp_output_7_0_g60737 + dotResult8_g60737 );
					float2 temp_output_597_26_g60734 = ( UV100_g60735 + frac( ( ( (temp_output_12_0_g60737).xx + (temp_output_12_0_g60737).yz ) * (temp_output_12_0_g60737).zy ) ) );
					float temp_output_66_0_g60735 = ( 1.0 - break55_g60735.y );
					float ifLocalVar60_g60735 = 0;
					if( temp_output_56_0_g60735 <= 0.0 )
					ifLocalVar60_g60735 = temp_output_66_0_g60735;
					else
					ifLocalVar60_g60735 = break55_g60735.y;
					float temp_output_597_28_g60734 = ifLocalVar60_g60735;
					float2 ifLocalVar89_g60735 = 0;
					if( temp_output_56_0_g60735 > 0.0 )
					ifLocalVar89_g60735 = temp_output_123_0_g60735;
					else if( temp_output_56_0_g60735 == 0.0 )
					ifLocalVar89_g60735 = temp_output_90_0_g60735;
					else if( temp_output_56_0_g60735 < 0.0 )
					ifLocalVar89_g60735 = temp_output_90_0_g60735;
					float3 temp_output_7_0_g60738 = frac( ( (ifLocalVar89_g60735).xyx * float3( 0.1031, 0.103, 0.0973 ) ) );
					float dotResult8_g60738 = dot( temp_output_7_0_g60738 , ( (temp_output_7_0_g60738).yzx + 33.33 ) );
					float3 temp_output_12_0_g60738 = ( temp_output_7_0_g60738 + dotResult8_g60738 );
					float2 temp_output_597_27_g60734 = ( UV100_g60735 + frac( ( ( (temp_output_12_0_g60738).xx + (temp_output_12_0_g60738).yz ) * (temp_output_12_0_g60738).zy ) ) );
					float temp_output_67_0_g60735 = ( 1.0 - break55_g60735.x );
					float ifLocalVar61_g60735 = 0;
					if( temp_output_56_0_g60735 <= 0.0 )
					ifLocalVar61_g60735 = temp_output_67_0_g60735;
					else
					ifLocalVar61_g60735 = break55_g60735.x;
					float temp_output_597_29_g60734 = ifLocalVar61_g60735;
					float4 Output_2D293_g60734 = ( ( tex2D( _MainTex, temp_output_597_0_g60734, DDX631_g60734, DDY632_g60734 ) * temp_output_597_30_g60734 ) + ( tex2D( _MainTex, temp_output_597_26_g60734, DDX631_g60734, DDY632_g60734 ) * temp_output_597_28_g60734 ) + ( tex2D( _MainTex, temp_output_597_27_g60734, DDX631_g60734, DDY632_g60734 ) * temp_output_597_29_g60734 ) );
					#ifdef _STOCHASTICENABLED_ON
					float4 staticSwitch1001_g60687 = Output_2D293_g60734;
					#else
					float4 staticSwitch1001_g60687 = tex2D( _MainTex, UV02420_g60687 );
					#endif
					#ifdef _MAINTEX
					float4 staticSwitch1549_g60687 = staticSwitch1001_g60687;
					#else
					float4 staticSwitch1549_g60687 = _Color;
					#endif
					float4 oAlbedo6_g60687 = staticSwitch1549_g60687;
					float Black1185_g60687 = 0.0;
					float4 temp_cast_0 = (Black1185_g60687).xxxx;
					#ifdef _LIGHTMAPDEBUG
					float4 staticSwitch1180_g60687 = temp_cast_0;
					#else
					float4 staticSwitch1180_g60687 = oAlbedo6_g60687;
					#endif
					
					float4 temp_output_1_0_g60740 = ScreenPos;
					float4 screenPos8_g60740 = temp_output_1_0_g60740;
					float3 viewDir8_g60740 = ViewDirWS;
					float3 worldNormal8_g60740 = NormalWS;
					float _Steps8_g60740 = 50.0;
					float _BinarySteps8_g60740 = 8.0;
					float _Thickness8_g60740 = 0.02;
					float4 localMyCustomExpression8_g60740 = MyCustomExpression8_g60740( screenPos8_g60740 , viewDir8_g60740 , worldNormal8_g60740 , _Steps8_g60740 , _BinarySteps8_g60740 , _Thickness8_g60740 );
					float4 screenColor9_g60740 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,(localMyCustomExpression8_g60740).xy);
					

					o.Albedo = staticSwitch1180_g60687.rgb;
					...
					o.Emission = screenColor9_g60740.rgb;
					o.Alpha = 1;
		...
		Pass
		{
			...
			CGPROGRAM
				...
				)
				{
					...
					float2 texCoord2357_g60687 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
					half2 UV02420_g60687 = texCoord2357_g60687;
					float2 temp_output_5_0_g60734 = UV02420_g60687;
					float2 UV633_g60734 = temp_output_5_0_g60734;
					float2 UV100_g60735 = UV633_g60734;
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;5289;-144,-1280;Inherit;False;Meenphie;0;;60687;b3ba55a08dd6b49c7be16c6f35cf2033;1,1008,0;0;5;COLOR;625;COLOR;624;FLOAT;156;FLOAT;427;FLOAT3;1024
...
WireConnection;5280;0;5289;625
WireConnection;5280;2;5289;624
ASEEND*/
//CHKSM=5C1528420BBCAD1827662836715FE16C4CA58DF9