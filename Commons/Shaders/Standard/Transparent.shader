...
Shader "Meenphie/Standard/Transparent"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			#ifdef _MAINTEX
				float4 staticSwitch899_g2555 = tex2D( _MainTex, uv_MainTex907_g2555 );
			#else
				float4 staticSwitch899_g2555 = _Color;
			#endif
			float4 Albedo6_g2555 = staticSwitch899_g2555;
			...
			#ifdef _EMISSION_ON
				float4 staticSwitch851_g2555 = ( _EmissionColor + tex2D( _EmissionMap, uv_EmissionMap81_g2555 ) );
			#else
				float4 staticSwitch851_g2555 = temp_cast_1;
			#endif
			float4 Emission86_g2555 = staticSwitch851_g2555;
			...
			#ifdef _MAINTEX
				float staticSwitch900_g2555 = tex2D( _MainTex, uv_MainTex907_g2555 ).a;
			#else
...
/*ASEBEGIN
Version=19904
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2644;192,-1200;Inherit;False;Meenphie;0;;2555;b3ba55a08dd6b49c7be16c6f35cf2033;10,871,0,872,0,869,0,847,1,867,0,947,0,912,0,944,0,938,0,905,0;0;9;COLOR;625;FLOAT3;238;COLOR;624;FLOAT;96;FLOAT;97;FLOAT;95;FLOAT;156;FLOAT;427;FLOAT3;860
...
ASEEND*/
//CHKSM=A879EAD4150AEEBE42E4BA7F1FE86E2C535FE80A