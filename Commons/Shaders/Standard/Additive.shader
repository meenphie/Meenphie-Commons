	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				float3 IndirectSpecularWithBoxProjection1_g60165( float Color, float Metallic, float Smoothness, float IOR, float3 Fresnel, float3 WorldPos, float3 WorldNormal, float3 ViewDir )
				{
					// --- 1. VECTEURS ---
							...
							) : SV_Target
				{
					...
					float Color1_g60165 = oAlbedo6_g60114.x;
					...
					float3 localIndirectSpecularWithBoxProjection1_g60165 = IndirectSpecularWithBoxProjection1_g60165( Color1_g60165 , Metallic1_g60165 , Smoothness1_g60165 , IOR1_g60165 , Fresnel1_g60165 , WorldPos1_g60165 , WorldNormal1_g60165 , ViewDir1_g60165 );
					float3 temp_output_2743_0_g60114 = localIndirectSpecularWithBoxProjection1_g60165;
					float grayscale2713_g60114 = Luminance( Lightmap46_g60114 );
					float smoothstepResult2430_g60114 = smoothstep( 0.0 , 0.5 , grayscale2713_g60114);
					#ifdef _USELIGHTMAPPEDREFLECTIONS_ON
					float3 staticSwitch1469_g60114 = ( temp_output_2743_0_g60114 * smoothstepResult2430_g60114 );
					#else
					float3 staticSwitch1469_g60114 = temp_output_2743_0_g60114;
					#endif
					float3 Reflections1419_g60114 = staticSwitch1469_g60114;
					float3 AlbedoColor97_g60166 = oAlbedo6_g60114;
					...
					float3 Fresnel97_g60166 = Fresnel1560_g60114;
					...
					float3 localSpecular97_g60166 = Specular( AlbedoColor97_g60166 , LightmapColor97_g60166 , Metallic97_g60166 , Smoothness97_g60166 , IOR97_g60166 , Fresnel97_g60166 , WorldPos97_g60166 , WorldNormal97_g60166 , ViewDir97_g60166 );
					float3 Speculars2560_g60114 = localSpecular97_g60166;
					#ifdef _LIGHTMAPDEBUG
