	...
	LOD 0
		...
		Pass
		{
			...
			CGPROGRAM
				...
				float3 IndirectSpecularWithBoxProjection1_g59698( float3 WorldPos, float3 WorldNormal, float3 ViewDir, float3 Fresnel, float Smoothness )
				{
							...
							) : SV_Target
				{
					...
					float Lightmap_Lerp_Value969_g59572 = _UdonLightmapLerp;
					...
					float4 TexelSize2_g59581 = _UdonRNMX0_TexelSize;
					...
					float4 lerpResult181_g59582 = lerp( tex2D( _UdonRNMX0, (Input_FetchOffsets197_g59582).yw ) , tex2D( _UdonRNMX0, (Input_FetchOffsets197_g59582).xw ) , break187_g59582.x);
					float4 lerpResult182_g59582 = lerp( tex2D( _UdonRNMX0, (Input_FetchOffsets197_g59582).yz ) , tex2D( _UdonRNMX0, (Input_FetchOffsets197_g59582).xz ) , break187_g59582.x);
					...
					#else
					float4 staticSwitch1061_g59572 = tex2D( _UdonRNMX0, UV0B2361_g59572 );
					#endif
					...
					float4 lerpResult181_g59583 = lerp( tex2D( _UdonRNMY0, (Input_FetchOffsets197_g59583).yw ) , tex2D( _UdonRNMY0, (Input_FetchOffsets197_g59583).xw ) , break187_g59583.x);
					float4 lerpResult182_g59583 = lerp( tex2D( _UdonRNMY0, (Input_FetchOffsets197_g59583).yz ) , tex2D( _UdonRNMY0, (Input_FetchOffsets197_g59583).xz ) , break187_g59583.x);
					...
					#else
					float4 staticSwitch1062_g59572 = tex2D( _UdonRNMY0, UV0B2361_g59572 );
					#endif
					...
					float4 lerpResult181_g59584 = lerp( tex2D( _UdonRNMZ0, (Input_FetchOffsets197_g59584).yw ) , tex2D( _UdonRNMZ0, (Input_FetchOffsets197_g59584).xw ) , break187_g59584.x);
					float4 lerpResult182_g59584 = lerp( tex2D( _UdonRNMZ0, (Input_FetchOffsets197_g59584).yz ) , tex2D( _UdonRNMZ0, (Input_FetchOffsets197_g59584).xz ) , break187_g59584.x);
					...
					#else
					float4 staticSwitch1063_g59572 = tex2D( _UdonRNMZ0, UV0B2361_g59572 );
					#endif
					...
					float4 TexelSize2_g59574 = _UdonRNMX1_TexelSize;
					...
					float4 lerpResult181_g59575 = lerp( tex2D( _UdonRNMX1, (Input_FetchOffsets197_g59575).yw ) , tex2D( _UdonRNMX1, (Input_FetchOffsets197_g59575).xw ) , break187_g59575.x);
					float4 lerpResult182_g59575 = lerp( tex2D( _UdonRNMX1, (Input_FetchOffsets197_g59575).yz ) , tex2D( _UdonRNMX1, (Input_FetchOffsets197_g59575).xz ) , break187_g59575.x);
					...
					#else
					float4 staticSwitch1087_g59572 = tex2D( _UdonRNMX1, UV0B2361_g59572 );
					#endif
					...
					float4 lerpResult181_g59576 = lerp( tex2D( _UdonRNMY1, (Input_FetchOffsets197_g59576).yw ) , tex2D( _UdonRNMY1, (Input_FetchOffsets197_g59576).xw ) , break187_g59576.x);
					float4 lerpResult182_g59576 = lerp( tex2D( _UdonRNMY1, (Input_FetchOffsets197_g59576).yz ) , tex2D( _UdonRNMY1, (Input_FetchOffsets197_g59576).xz ) , break187_g59576.x);
					...
					#else
					float4 staticSwitch1083_g59572 = tex2D( _UdonRNMY1, UV0B2361_g59572 );
					#endif
					...
					float4 lerpResult181_g59577 = lerp( tex2D( _UdonRNMZ1, (Input_FetchOffsets197_g59577).yw ) , tex2D( _UdonRNMZ1, (Input_FetchOffsets197_g59577).xw ) , break187_g59577.x);
					float4 lerpResult182_g59577 = lerp( tex2D( _UdonRNMZ1, (Input_FetchOffsets197_g59577).yz ) , tex2D( _UdonRNMZ1, (Input_FetchOffsets197_g59577).xz ) , break187_g59577.x);
					...
					#else
					float4 staticSwitch1084_g59572 = tex2D( _UdonRNMZ1, UV0B2361_g59572 );
					#endif
					...
					float2 temp_output_5_0_g59692 = UV0A2420_g59572;
					...
					float4 Output_2D293_g59692 = ( ( tex2D( _Sampler82968_g59572, temp_output_597_0_g59692, DDX631_g59692, DDY632_g59692 ) * temp_output_597_30_g59692 ) + ( tex2D( _Sampler82968_g59572, temp_output_597_26_g59692, DDX631_g59692, DDY632_g59692 ) * temp_output_597_28_g59692 ) + ( tex2D( _Sampler82968_g59572, temp_output_597_27_g59692, DDX631_g59692, DDY632_g59692 ) * temp_output_597_29_g59692 ) );
					#ifdef _STOCHASTICENABLED_ON
					float4 staticSwitch1006_g59572 = Output_2D293_g59692;
					#else
					float4 staticSwitch1006_g59572 = tex2D( _EmissionMap, UV0A2420_g59572 );
					#endif
					float3 temp_output_2531_0_g59572 = (( float4( _EmissionColor , 0.0 ) * staticSwitch1006_g59572 * _EmissionIntensity )).rgb;
					float3 Emission86_g59572 = temp_output_2531_0_g59572;
					float3 temp_cast_4 = (Black1185_g59572).xxx;
					float3 temp_cast_5 = (Black1185_g59572).xxx;
					float3 World_Position2505_g59572 = PositionWS;
					float3 WorldPos1_g59698 = World_Position2505_g59572;
					...
					float3 WorldNormal1_g59698 = World_Normal2508_g59572;
					float3 View_Direction2511_g59572 = ViewDirWS;
					float3 ViewDir1_g59698 = View_Direction2511_g59572;
					...
					float3 Fresnel1_g59698 = Fresnel1560_g59572;
					...
					float4 Output_2D293_g59686 = ( ( tex2D( _Sampler82964_g59572, temp_output_597_0_g59686, DDX631_g59686, DDY632_g59686 ) * temp_output_597_30_g59686 ) + ( tex2D( _Sampler82964_g59572, temp_output_597_26_g59686, DDX631_g59686, DDY632_g59686 ) * temp_output_597_28_g59686 ) + ( tex2D( _Sampler82964_g59572, temp_output_597_27_g59686, DDX631_g59686, DDY632_g59686 ) * temp_output_597_29_g59686 ) );
					...
					#endif
					float Smoothness1399_g59572 = staticSwitch15_g59691;
					float Smoothness1_g59698 = Smoothness1399_g59572;
					float3 localIndirectSpecularWithBoxProjection1_g59698 = IndirectSpecularWithBoxProjection1_g59698( WorldPos1_g59698 , WorldNormal1_g59698 , ViewDir1_g59698 , Fresnel1_g59698 , Smoothness1_g59698 );
					float3 lerpResult2658_g59572 = lerp( temp_cast_5 , localIndirectSpecularWithBoxProjection1_g59698 , Metallic1239_g59572);
					#ifdef _IsMetallic
					float3 staticSwitch2657_g59572 = lerpResult2658_g59572;
					#else
					float3 staticSwitch2657_g59572 = temp_cast_4;
					#endif
					...
					float3 staticSwitch1469_g59572 = ( staticSwitch2657_g59572 * smoothstepResult2430_g59572 );
					#else
					float3 staticSwitch1469_g59572 = staticSwitch2657_g59572;
					#endif
					float3 Reflections1419_g59572 = staticSwitch1469_g59572;
					float3 AlbedoColor97_g59703 = oAlbedo6_g59572;
					float3 LightmapColor97_g59703 = Lightmap46_g59572;
					float Metallic97_g59703 = Metallic1239_g59572;
					float Smoothness97_g59703 = Smoothness1399_g59572;
					float3 Fresnel97_g59703 = Fresnel1560_g59572;
					float3 WorldPos97_g59703 = World_Position2505_g59572;
					float3 WorldNormal97_g59703 = World_Normal2508_g59572;
					float3 ViewDir97_g59703 = View_Direction2511_g59572;
					float3 localSpecular97_g59703 = Specular( AlbedoColor97_g59703 , LightmapColor97_g59703 , Metallic97_g59703 , Smoothness97_g59703 , Fresnel97_g59703 , WorldPos97_g59703 , WorldNormal97_g59703 , ViewDir97_g59703 );
					float3 Speculars2560_g59572 = localSpecular97_g59703;
					#ifdef _LIGHTMAPDEBUG
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3248;192,-1152;Inherit;False;Meenphie;0;;59572;b3ba55a08dd6b49c7be16c6f35cf2033;5,1008,0,2632,0,2619,0,2635,0,2636,0;0;5;FLOAT3;625;FLOAT3;624;FLOAT;156;FLOAT;427;FLOAT;1024
...
ASEEND*/
//CHKSM=3EB7D76F94B551900C00F39D05FC7B604267C6FC