    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float3 temp_output_35_0_g33 = ( IN.color * ColorHDR ).rgb;
                float3 Color353_g33 = temp_output_35_0_g33;
                #if defined( _LUTMODE_2D )
                float3 staticSwitch273_g33 = saturate( temp_output_35_0_g33 );
                #elif defined( _LUTMODE_3D )
                float3 staticSwitch273_g33 = temp_output_35_0_g33;
                #else
                float3 staticSwitch273_g33 = temp_output_35_0_g33;
                #endif
                float3 Color_Saturate49_g33 = staticSwitch273_g33;
                ...
                float2 Adjusted_UV305_g33 = ( ( (Color_Saturate49_g33).xy * Scale_Factor292_g33 ) + Offset299_g33 );
                float Scaled_Blue280_g33 = ( (Color_Saturate49_g33).z * (Scale_Offset208_g33).z );
                float Shift288_g33 = floor( Scaled_Blue280_g33 );
                float Final_X313_g33 = ( (Adjusted_UV305_g33).x + ( Shift288_g33 * (Scale_Offset208_g33).y ) );
                float2 appendResult326_g33 = (float2(Final_X313_g33 , (Adjusted_UV305_g33).y));
                ...
                float3 lerpResult333_g33 = lerp( tex2D( _2DLut, Final_UV325_g33 ).rgb , tex2D( _2DLut, Offset_UV336_g33 ).rgb , ( Scaled_Blue280_g33 - Shift288_g33 ));
                #ifdef _2DLUT
                float3 staticSwitch347_g33 = lerpResult333_g33;
                #else
                float3 staticSwitch347_g33 = Color_Saturate49_g33;
                #endif
                float3 TwoD_LUT346_g33 = staticSwitch347_g33;
                float3 RGB16_g34 = ( ( log10( ( ( Color_Saturate49_g33 * 5.555556 ) + 0.047996 ) ) * 0.244161 ) + 0.386036 );
                #ifdef _3DLUT
                float3 staticSwitch194_g33 = tex3D( _3DLut, RGB16_g34 ).rgb;
                #else
                float3 staticSwitch194_g33 = Color_Saturate49_g33;
                #endif
                float3 ThreeD_LUT51_g33 = staticSwitch194_g33;
                #if defined( _LUTMODE_2D )
                float3 staticSwitch42_g33 = TwoD_LUT346_g33;
                #elif defined( _LUTMODE_3D )
                float3 staticSwitch42_g33 = ThreeD_LUT51_g33;
                #else
                float3 staticSwitch42_g33 = ThreeD_LUT51_g33;
                #endif
                #ifdef SHADER_API_MOBILE
                float3 staticSwitch41_g33 = staticSwitch42_g33;
                #else
                float3 staticSwitch41_g33 = Color353_g33;
                #endif
                

                half4 color = ( ( _Color + tex2DNode114 ) * float4( staticSwitch41_g33 , 0.0 ) );
