...
Shader "Meenphie/Lightmapped/RNM/Stochastic/Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 appendResult139_g2302 = (float3(sqrt( ( 2.0 / 3.0 ) ) , 0.0 , ( 1.0 / sqrt( 3.0 ) )));
			float3 normalizeResult326_g2302 = normalize( Normal_Map700_g2287 );
			float3 Normal_Map318_g2302 = normalizeResult326_g2302;
			float dotResult121_g2302 = dot( appendResult139_g2302 , Normal_Map318_g2302 );
			float localStochasticTiling2_g2298 = ( 0.0 );
			float2 uv3_RNMX0 = i.uv3_texcoord3 * _RNMX0_ST.xy + _RNMX0_ST.zw;
			float2 UV2_g2298 = uv3_RNMX0;
			float4 TexelSize2_g2298 = _RNMX0_TexelSize;
			float4 Offsets2_g2298 = float4( 0,0,0,0 );
			float2 Weights2_g2298 = float2( 0,0 );
			{
			UV2_g2298 = UV2_g2298 * TexelSize2_g2298.zw - 0.5;
			float2 f = frac( UV2_g2298 );
			UV2_g2298 -= f;
			...
			float4 c = float4( UV2_g2298.x - 0.5, UV2_g2298.x + 1.5, UV2_g2298.y - 0.5, UV2_g2298.y + 1.5 );
			float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
			float w0 = s.x / ( s.x + s.y );
			float w1 = s.z / ( s.z + s.w );
			Offsets2_g2298 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g2298.xyxy;
			Weights2_g2298 = float2( w0, w1 );
			}
			float4 temp_output_1_34_g2297 = Offsets2_g2298;
			float4 Input_FetchOffsets197_g2301 = temp_output_1_34_g2297;
			float2 temp_output_1_54_g2297 = Weights2_g2298;
			float2 Input_FetchWeights200_g2301 = temp_output_1_54_g2297;
			float2 break187_g2301 = Input_FetchWeights200_g2301;
			float4 lerpResult181_g2301 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g2301).yw ) , tex2D( _RNMX0, (Input_FetchOffsets197_g2301).xw ) , break187_g2301.x);
			float4 lerpResult182_g2301 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g2301).yz ) , tex2D( _RNMX0, (Input_FetchOffsets197_g2301).xz ) , break187_g2301.x);
			float4 lerpResult176_g2301 = lerp( lerpResult181_g2301 , lerpResult182_g2301 , break187_g2301.y);
			float4 Output_Fetch2D202_g2301 = lerpResult176_g2301;
			float3 appendResult146_g2302 = (float3(( -1.0 / sqrt( 6.0 ) ) , ( 1.0 / sqrt( 2.0 ) ) , ( 1.0 / sqrt( 3.0 ) )));
			float dotResult122_g2302 = dot( appendResult146_g2302 , Normal_Map318_g2302 );
			float4 Input_FetchOffsets197_g2299 = temp_output_1_34_g2297;
			float2 Input_FetchWeights200_g2299 = temp_output_1_54_g2297;
			float2 break187_g2299 = Input_FetchWeights200_g2299;
			float4 lerpResult181_g2299 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g2299).yw ) , tex2D( _RNMY0, (Input_FetchOffsets197_g2299).xw ) , break187_g2299.x);
			float4 lerpResult182_g2299 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g2299).yz ) , tex2D( _RNMY0, (Input_FetchOffsets197_g2299).xz ) , break187_g2299.x);
			float4 lerpResult176_g2299 = lerp( lerpResult181_g2299 , lerpResult182_g2299 , break187_g2299.y);
			float4 Output_Fetch2D202_g2299 = lerpResult176_g2299;
			float3 appendResult149_g2302 = (float3(( -1.0 / sqrt( 6.0 ) ) , ( -1.0 / sqrt( 2.0 ) ) , ( 1.0 / sqrt( 3.0 ) )));
			float dotResult120_g2302 = dot( appendResult149_g2302 , Normal_Map318_g2302 );
			float4 Input_FetchOffsets197_g2300 = temp_output_1_34_g2297;
			float2 Input_FetchWeights200_g2300 = temp_output_1_54_g2297;
			float2 break187_g2300 = Input_FetchWeights200_g2300;
			float4 lerpResult181_g2300 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g2300).yw ) , tex2D( _RNMZ0, (Input_FetchOffsets197_g2300).xw ) , break187_g2300.x);
			float4 lerpResult182_g2300 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g2300).yz ) , tex2D( _RNMZ0, (Input_FetchOffsets197_g2300).xz ) , break187_g2300.x);
			float4 lerpResult176_g2300 = lerp( lerpResult181_g2300 , lerpResult182_g2300 , break187_g2300.y);
			float4 Output_Fetch2D202_g2300 = lerpResult176_g2300;
			float4 RNM_0926_g2287 = ( ( ( saturate( dotResult121_g2302 ) * ( Output_Fetch2D202_g2301 * 0.8 ) ) + ( saturate( dotResult122_g2302 ) * ( Output_Fetch2D202_g2299 * 0.8 ) ) ) + ( saturate( dotResult120_g2302 ) * ( Output_Fetch2D202_g2300 * 0.8 ) ) );
			...
			float4 lerpResult882_g2287 = lerp( RNM_0926_g2287 , temp_cast_2 , float4( 0,0,0,0 ));
...
ASEEND*/
//CHKSM=12FE2A58203DA5C57C162A5F606A9E3F8463926F