...
Shader "Meenphie/Lightmapped/RNM/Outline/Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 appendResult139_g1969 = (float3(sqrt( ( 2.0 / 3.0 ) ) , 0.0 , ( 1.0 / sqrt( 3.0 ) )));
			float3 normalizeResult326_g1969 = normalize( Normal_Map700_g1954 );
			float3 Normal_Map318_g1969 = normalizeResult326_g1969;
			float dotResult121_g1969 = dot( appendResult139_g1969 , Normal_Map318_g1969 );
			float localStochasticTiling2_g1965 = ( 0.0 );
			float2 uv3_RNMX0 = i.uv3_texcoord3 * _RNMX0_ST.xy + _RNMX0_ST.zw;
			float2 UV2_g1965 = uv3_RNMX0;
			float4 TexelSize2_g1965 = _RNMX0_TexelSize;
			float4 Offsets2_g1965 = float4( 0,0,0,0 );
			float2 Weights2_g1965 = float2( 0,0 );
			{
			UV2_g1965 = UV2_g1965 * TexelSize2_g1965.zw - 0.5;
			float2 f = frac( UV2_g1965 );
			UV2_g1965 -= f;
			...
			float4 c = float4( UV2_g1965.x - 0.5, UV2_g1965.x + 1.5, UV2_g1965.y - 0.5, UV2_g1965.y + 1.5 );
			float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
			float w0 = s.x / ( s.x + s.y );
			float w1 = s.z / ( s.z + s.w );
			Offsets2_g1965 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g1965.xyxy;
			Weights2_g1965 = float2( w0, w1 );
			}
			float4 temp_output_1_34_g1964 = Offsets2_g1965;
			float4 Input_FetchOffsets197_g1968 = temp_output_1_34_g1964;
			float2 temp_output_1_54_g1964 = Weights2_g1965;
			float2 Input_FetchWeights200_g1968 = temp_output_1_54_g1964;
			float2 break187_g1968 = Input_FetchWeights200_g1968;
			float4 lerpResult181_g1968 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g1968).yw ) , tex2D( _RNMX0, (Input_FetchOffsets197_g1968).xw ) , break187_g1968.x);
			float4 lerpResult182_g1968 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g1968).yz ) , tex2D( _RNMX0, (Input_FetchOffsets197_g1968).xz ) , break187_g1968.x);
			...
			float3 appendResult146_g1969 = (float3(( -1.0 / sqrt( 6.0 ) ) , ( 1.0 / sqrt( 2.0 ) ) , ( 1.0 / sqrt( 3.0 ) )));
			float dotResult122_g1969 = dot( appendResult146_g1969 , Normal_Map318_g1969 );
			float4 Input_FetchOffsets197_g1966 = temp_output_1_34_g1964;
			float2 Input_FetchWeights200_g1966 = temp_output_1_54_g1964;
			float2 break187_g1966 = Input_FetchWeights200_g1966;
			float4 lerpResult181_g1966 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g1966).yw ) , tex2D( _RNMY0, (Input_FetchOffsets197_g1966).xw ) , break187_g1966.x);
			float4 lerpResult182_g1966 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g1966).yz ) , tex2D( _RNMY0, (Input_FetchOffsets197_g1966).xz ) , break187_g1966.x);
			float4 lerpResult176_g1966 = lerp( lerpResult181_g1966 , lerpResult182_g1966 , break187_g1966.y);
			float4 Output_Fetch2D202_g1966 = lerpResult176_g1966;
			float3 appendResult149_g1969 = (float3(( -1.0 / sqrt( 6.0 ) ) , ( -1.0 / sqrt( 2.0 ) ) , ( 1.0 / sqrt( 3.0 ) )));
			float dotResult120_g1969 = dot( appendResult149_g1969 , Normal_Map318_g1969 );
			float4 Input_FetchOffsets197_g1967 = temp_output_1_34_g1964;
			float2 Input_FetchWeights200_g1967 = temp_output_1_54_g1964;
			float2 break187_g1967 = Input_FetchWeights200_g1967;
			float4 lerpResult181_g1967 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g1967).yw ) , tex2D( _RNMZ0, (Input_FetchOffsets197_g1967).xw ) , break187_g1967.x);
			float4 lerpResult182_g1967 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g1967).yz ) , tex2D( _RNMZ0, (Input_FetchOffsets197_g1967).xz ) , break187_g1967.x);
			...
			float4 RNM_0926_g1954 = ( ( ( saturate( dotResult121_g1969 ) * ( Output_Fetch2D202_g1968 * 0.8 ) ) + ( saturate( dotResult122_g1969 ) * ( Output_Fetch2D202_g1966 * 0.8 ) ) ) + ( saturate( dotResult120_g1969 ) * ( Output_Fetch2D202_g1967 * 0.8 ) ) );
			...
			float4 lerpResult882_g1954 = lerp( RNM_0926_g1954 , temp_cast_2 , float4( 0,0,0,0 ));
...
ASEEND*/
//CHKSM=0F4481C70BC75772088BC392147E83D27FEA124B