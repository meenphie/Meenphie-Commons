		...
		Pass
		{
			...
			CGPROGRAM
							...
							) : SV_Target
				{
					...
					float3 lerpResult1473_g59916 = lerp( temp_cast_4 , oAlbedo6_g59916 , Metallic1239_g59916);
					...
					float3 temp_output_2652_0_g59916 = localIndirectSpecularWithBoxProjection1_g59967;
					float3 temp_cast_5 = (0.0).xxx;
					float3 temp_cast_6 = (0.1).xxx;
					float3 smoothstepResult2430_g59916 = smoothstep( temp_cast_5 , temp_cast_6 , Lightmap46_g59916);
					#ifdef _USELIGHTMAPPEDREFLECTIONS_ON
					float3 staticSwitch1469_g59916 = ( temp_output_2652_0_g59916 * smoothstepResult2430_g59916 );
					#else
					float3 staticSwitch1469_g59916 = temp_output_2652_0_g59916;
					#endif
...
ASEEND*/
//CHKSM=96738914D15781C49BCBF72B0E99F01B78DA548C