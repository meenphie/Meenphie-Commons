Shader /*ase_name*/ "Hidden/Built-In/Unlit Meenphie" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		...
		Option:Rendering Mode:Opaque,Transparent,Masked:Opaque
		Opaque:SetTag:RenderType,Opaque
		Opaque:SetTag:Queue,Geometry
		Opaque:SetBlendMode:Off
		Opaque:SetZWrite:On
		Transparent:SetTag:RenderType,Transparent
		Transparent:SetTag:Queue,Transparent
		Transparent:SetTag:IgnoreProjector,True
		Transparent:SetBlendMode:SrcAlpha,OneMinusSrcAlpha
		Transparent:SetZWrite:Off
		Masked:SetTag:RenderType,TransparentCutout
		Masked:SetTag:Queue,AlphaTest
		Masked:SetBlendMode:Off
		Masked:SetZWrite:On
		Masked:SetDefine:_ALPHATEST_ON
		Masked:ShowPort:Alpha Clip Threshold
