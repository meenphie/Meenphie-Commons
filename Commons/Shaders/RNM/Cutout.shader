...
Shader "Meenphie/RNM/Cutout"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float localStochasticTiling2_g1958 = ( 0.0 );
			float2 uv3_RNMX0 = i.uv3_texcoord3 * _RNMX0_ST.xy + _RNMX0_ST.zw;
			float2 UV2_g1958 = uv3_RNMX0;
			float4 TexelSize2_g1958 = _RNMX0_TexelSize;
			float4 Offsets2_g1958 = float4( 0,0,0,0 );
			float2 Weights2_g1958 = float2( 0,0 );
			{
			UV2_g1958 = UV2_g1958 * TexelSize2_g1958.zw - 0.5;
			float2 f = frac( UV2_g1958 );
			UV2_g1958 -= f;
			...
			float4 c = float4( UV2_g1958.x - 0.5, UV2_g1958.x + 1.5, UV2_g1958.y - 0.5, UV2_g1958.y + 1.5 );
			float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
			float w0 = s.x / ( s.x + s.y );
			float w1 = s.z / ( s.z + s.w );
			Offsets2_g1958 = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g1958.xyxy;
			Weights2_g1958 = float2( w0, w1 );
			}
			float4 temp_output_1_34_g1957 = Offsets2_g1958;
			float4 Input_FetchOffsets197_g1961 = temp_output_1_34_g1957;
			float2 temp_output_1_54_g1957 = Weights2_g1958;
			float2 Input_FetchWeights200_g1961 = temp_output_1_54_g1957;
			float2 break187_g1961 = Input_FetchWeights200_g1961;
			float3 lerpResult181_g1961 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g1961).yw ).rgb , tex2D( _RNMX0, (Input_FetchOffsets197_g1961).xw ).rgb , break187_g1961.x);
			float3 lerpResult182_g1961 = lerp( tex2D( _RNMX0, (Input_FetchOffsets197_g1961).yz ).rgb , tex2D( _RNMX0, (Input_FetchOffsets197_g1961).xz ).rgb , break187_g1961.x);
			...
			float4 Input_FetchOffsets197_g1959 = temp_output_1_34_g1957;
			float2 Input_FetchWeights200_g1959 = temp_output_1_54_g1957;
			float2 break187_g1959 = Input_FetchWeights200_g1959;
			float3 lerpResult181_g1959 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g1959).yw ).rgb , tex2D( _RNMY0, (Input_FetchOffsets197_g1959).xw ).rgb , break187_g1959.x);
			float3 lerpResult182_g1959 = lerp( tex2D( _RNMY0, (Input_FetchOffsets197_g1959).yz ).rgb , tex2D( _RNMY0, (Input_FetchOffsets197_g1959).xz ).rgb , break187_g1959.x);
			float3 lerpResult176_g1959 = lerp( lerpResult181_g1959 , lerpResult182_g1959 , break187_g1959.y);
			float3 Output_Fetch2D202_g1959 = lerpResult176_g1959;
			...
			float4 Input_FetchOffsets197_g1960 = temp_output_1_34_g1957;
			float2 Input_FetchWeights200_g1960 = temp_output_1_54_g1957;
			float2 break187_g1960 = Input_FetchWeights200_g1960;
			float3 lerpResult181_g1960 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g1960).yw ).rgb , tex2D( _RNMZ0, (Input_FetchOffsets197_g1960).xw ).rgb , break187_g1960.x);
			float3 lerpResult182_g1960 = lerp( tex2D( _RNMZ0, (Input_FetchOffsets197_g1960).yz ).rgb , tex2D( _RNMZ0, (Input_FetchOffsets197_g1960).xz ).rgb , break187_g1960.x);
...
ASEEND*/
//CHKSM=05347335A301BB33313EDA9C94B37D14548840DD