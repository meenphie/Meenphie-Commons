...
{
    public class Meenphie_DrawerGradient : MaterialPropertyDrawer
    {
        ...
        public Meenphie_DrawerGradient() : this(256, false) { }
        public Meenphie_DrawerGradient(float resolution) : this((int)resolution, false) { }
        public Meenphie_DrawerGradient(bool hdr) : this(256, hdr) { }
        public Meenphie_DrawerGradient(float resolution, string parameters) : this((int)resolution, ExtractHdrParameter(parameters)) { }

        private Meenphie_DrawerGradient(int resolution, bool hdr)
        {
