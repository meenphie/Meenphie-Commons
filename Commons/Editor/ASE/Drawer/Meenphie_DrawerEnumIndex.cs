...
namespace Meenphie.Drawers
{
    ...
    public class Meenphie_DrawerEnumIndex : MaterialPropertyDrawer
    {
        ...
        public Meenphie_DrawerEnumIndex(string options)
        {
        ...
        public Meenphie_DrawerEnumIndex (string options, float top, float down)
        {
            this.options = options;
