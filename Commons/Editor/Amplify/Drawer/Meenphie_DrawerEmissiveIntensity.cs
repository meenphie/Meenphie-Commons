...
public class Meenphie_DrawerEmissiveIntensity : MaterialPropertyDrawer
    {
        public string reference = "";
        public float top = 0;
        public float down = 0;

        public Meenphie_DrawerEmissiveIntensity()
        {
            this.top = 0;
            this.down = 0;
        }

        public Meenphie_DrawerEmissiveIntensity(string reference)
        {
        ...
        public Meenphie_DrawerEmissiveIntensity(float top, float down)
        {
            this.top = top;
            this.down = down;
        }

        public Meenphie_DrawerEmissiveIntensity(string reference, float top, float down)
        {
            this.reference = reference;
            this.top = top;
            this.down = down;
